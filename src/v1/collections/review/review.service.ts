...
export class ReviewService {
    ...
    async getReviewList(): Promise<Review[]> {
        try {
    ...
    async addReview(data: ReviewDto): Promise<Review> {
        try {
    ...
    async updateReview(id: string, updateData: ReviewDto): Promise<Review> {
        try {
    ...
    async deleteReview(id: string): Promise<string> {
        try {
            ...
            if(review != null) {
                ...
                return `${review.name} review has been deleted successfully`
            }
            throw new HttpException('Review not found', HttpStatus.NOT_FOUND)
        }catch(error) {
            throw new HttpException(error, error?.status)
